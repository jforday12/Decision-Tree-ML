...
def run_experiments():
    ...
    """
    clean_acc, clean_cm,unpruned_clean_tree_depth = evaluation.cross_validation(clean_dataset)
    noisy_acc, noisy_cm,unpruned_noisy_tree_depth = evaluation.cross_validation(noisy_dataset)
